...
/**
 * Represents a reservation for a cottage. Contains details about the reservation
 * such as start date, duration, customer, selected cottage, and the total price.
 */
public class Reservation {
    ...
    private float calculateTotalPrice() {
        ...
        return cottage != null ? cottage.getPricePerNight() * nights : 0f;
    }
