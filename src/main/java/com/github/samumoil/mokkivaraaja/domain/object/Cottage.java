...
/**
 * The Cottage class represents a rental property that includes attributes such as
 * identification, name, description, location, capacity, owner, and price per night.
 * It provides getter and setter methods for manipulating and retrieving the property details.
 */
